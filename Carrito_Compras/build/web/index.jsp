    ...
    <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Controlador?accion=Carrito">(<label style="color: bisque">${contador}</label>)Carrito</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="login.jsp">Registrarse</a>
                ...
                <c:forEach var="p" items="${productos}"> 
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <i>${p.getPrecio()}</i>
                                    <img src="Controlador_Imagen?id=${p.getId()}" width="200" height="180">
                            </div>
